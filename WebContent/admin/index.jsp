...
<body>
    ...
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="${pageContext.request.contextPath}/admin/index.jsp">天天生鲜后台</a></div>
        <div class="left_open">
      ...
      <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/UserServlet?method=queryAallUser">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>会员列表</cite>
