...
<html>
  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      <div class="layui-row">
        <form action="${pageContext.request.contextPath}/UserServlet?method=queryAallUser" method="post" class="layui-form layui-col-md12 x-so">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加用户','${pageContext.request.contextPath}/admin/member-add.jsp',600,400)"><i class="layui-icon"></i>添加</button>
